...
var instrucciones = ["Utilizar las flechas para mover las piezas", "Ordenar las piezas hasta alcanzar la imagen objetivo"]// Arreglo para ir guardando los movimientos que se vayan realizando
var movimientos = [];
...
function mostrarInstrucciones(instrucciones) {
  for (var i = 0; i < instrucciones.length; i++) {
    var lasInstrucciones = instrucciones[i];
    console.log(lasInstrucciones, mostrarInstruccionEnLista(lasInstrucciones,"lista-instrucciones"));
  }
...
function chequearSiGano() {//COMPLETAR
  var gano = true;
  var grillaordenada = [
    [1, 2, 3],
    [4, 5, 6],
...
function moverEnDireccion(direccion) {
  ...
  las funciones posicionValida, intercambiarPosicionesGrilla y actualizarPosicionVacia */
    ...
    if (posicionValida(nuevaFilaPiezaVacia, nuevaColumnaPiezaVacia)) {
        ...
        //lo que yo agregué está a continuación
